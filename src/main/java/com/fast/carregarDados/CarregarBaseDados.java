...
public class CarregarBaseDados {
	...
	CommandLineRunner initDatabase(ClienteRepository cliente, BancoRepository banco, CaixaRepository caixa) {
		...
		return args -> {
			...
			log.info("Carregando " + cliente.save(new Cliente("Francisco TESTE", "(74)99971-8965", "allan.teste",
					"1052", banco1.getCodigo(), banco1.getNome_extenso(), "2021001", (double) 1000)));
